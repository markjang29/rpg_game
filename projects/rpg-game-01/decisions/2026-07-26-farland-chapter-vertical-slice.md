...
- 전장을 8×8에서 20×16으로 확장했다.
- 남쪽 야영지, 메아리 다리, 별의 제단을 장거리 진행 축으로 배치했다.
- 카메라는 마우스·터치 드래그, 휠·버튼 줌, 전체 보기, 현재 유닛 추적, 전체화면을 지원한다.
- 사거리 밖의 적은 가장 가까운 아군을 향해 이동한 뒤 공격 가능 여부를 다시 판정한다.
